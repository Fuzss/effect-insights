...
public final class BeaconTooltipHandler extends TooltipDescriptionsHandler<MobEffectInstance> {
    private final MobEffectInstance mobEffect;

    public BeaconTooltipHandler(MobEffectInstance mobEffect) {
        this.mobEffect = mobEffect;
    }

    @Override
    protected TooltipDescriptionMode getTooltipDescriptionMode() {
        return EffectInsights.CONFIG.get(ClientConfig.class).effectBeaconTooltips.tooltipDescriptions;
    }
    ...
    protected @Nullable Component getValueComponent(MobEffectInstance mobEffect) {
        int maxWidth = EffectInsights.CONFIG.get(ClientConfig.class).effectBeaconTooltips.tooltipLines.maximumWidth;
    ...
    protected List<Component> getItemTooltipLines(MobEffectInstance mobEffectInstance) {
        return TooltipLinesExtractor.getTooltipLines(MobEffectTooltipLines.WIDGET_SUPPLIERS,
                mobEffectInstance,
                EffectInsights.CONFIG.get(ClientConfig.class).effectBeaconTooltips);
    }
}
